...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "epam-javafall-gwt" because\n';
  ...
  $wnd.__gwt_activeModules['epam-javafall-gwt'] = {
    'moduleName' : 'epam-javafall-gwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/epam-javafall-gwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['epam-javafall-gwt'].superdevmode = true;

  var expectedSuffix = '/epam-javafall-gwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + epam-javafall-gwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:epam-javafall-gwt';
  var devModeSessionKey = '__gwtDevModeSession:epam-javafall-gwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':58133';
  var nocacheUrl = serverUrl + '/epam-javafall-gwt/epam-javafall-gwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['epam-javafall-gwt'].canRedirect = true;
  $wnd.__gwt_activeModules['epam-javafall-gwt'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING epam-javafall-gwt';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/epam-javafall-gwt?user.agent=' + ua + '&_callback=' + callback;
