...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "gwt_project_4" because\n';
  ...
  $wnd.__gwt_activeModules['gwt_project_4'] = {
    'moduleName' : 'gwt_project_4',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/gwt_project_4.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['gwt_project_4'].superdevmode = true;

  var expectedSuffix = '/gwt_project_4.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + gwt_project_4 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:gwt_project_4';
  var devModeSessionKey = '__gwtDevModeSession:gwt_project_4';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':58133';
  var nocacheUrl = serverUrl + '/gwt_project_4/gwt_project_4.nocache.js';
  ...
  $wnd.__gwt_activeModules['gwt_project_4'].canRedirect = true;
  $wnd.__gwt_activeModules['gwt_project_4'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING gwt_project_4';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/gwt_project_4?user.agent=' + ua + '&_callback=' + callback;
