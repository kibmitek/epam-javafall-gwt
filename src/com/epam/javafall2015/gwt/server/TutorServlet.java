...
public class TutorServlet  extends AdvancedServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		if(((UserDTO)req.getSession().getAttribute("current_user"))==null){
			...
			page.append("<html><head><meta http-equiv=\"content-type\" content=\"text/html; charset=UTF-8\"><link type=\"text/css\" rel=\"stylesheet\" href=\"w3.css\"><script type=\"text/javascript\" src=\"../tutor/tutor.nocache.js\"></script></head><body></body></html>");
		}
	}
